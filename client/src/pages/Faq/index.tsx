      ...
      <div className="dc mb4" id="transactionRef">
        <div className="width70 d-flex flex-column justify-content-center align-items-center gp2 text-white padding0Mobile1">
            ...
            <div className="width70 flex-start-css mv2h1">
              <p className="text-justify">In cryptocurrency, the transaction speed depends on the amount of fee you pay. You can reduce transaction time by paying a higher fee.</p>
              <p className="text-justify">When using the Woodcoin QT wallet to transfer LOG, we recommend increasing the transaction fee to 0.001 LOG. Doing this can reduce the transaction time to 2-3 minutes.</p>
              <p className="text-justify">Follow the instructions below if you want to adjust the transaction fee.</p>
            </div>

            <p className="text-justify mv2h1">1. In your Woodcoin wallet, click on Settings in the top menu.</p>
            ...
            <p className="text-justify mv2h1">2. In the dropdown menu, click on Options.</p>
            ...
            <p className="text-justify mv2h1">3. In the Options window, click on the Wallet tab and adjust the Pay transaction fee amount to 0.001 LOG</p>
    ...
    return (
      <div className="dc mb4" id="Metamask">
        <div className="width70 d-flex flex-column justify-content-center align-items-center gp2 text-white padding0Mobile1">
            ...
            <div className="width70 flex-start-css mv2h1">
              <p className="text-justify">- Tap on the three horizontal bars in the upper left-hand corner</p>
              <p className="text-justify">- Tap on Settings</p>
              <p className="text-justify">- Tap on Networks</p>
              <p className="text-justify">- If Polygon Mainnet is not yet available in the network list, tap on Add Network</p>
              <p className="text-justify">- Tap on Polygon Mainnet</p>
              <p className="text-justify">- Tap on Approve and then "Switch to network"</p>
            </div>
            ...
            <div className="width70 flex-start-css mv2h1">
              <p className="text-justify">- Tap Import Tokens</p>
              <p className="text-justify">- Tap the Custom Token tab</p>
              <p className="text-justify">- Paste the WLOG contract address to the Token Address input field (0x89F8bE64Da35308260BA2d13d0d1e7Fd80A3A210)</p>
              <p className="text-justify">- Tap the IMPORT button, and WLOG will be available in your wallet</p>
            </div>
            ...
            <div className="width70 flex-start-css mv2h1">
              <p className="text-justify">- Tap on the three horizontal bars in the upper left-hand corner</p>
              <p className="text-justify">- Tap on Browser</p>
              <p className="text-justify">- Open a new tab using the search bar, or click the magnifying glass icon, and navigate to the wlog.network website </p>
            </div>
